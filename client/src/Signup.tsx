                        ...
                        <div className="p-12 bg-white mx-auto rounded-2xl w-100">
                            ...
                            <div className="space-y-5">
                                <div className="space-y-2">
                                    ...
                                    <input className=" w-full text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-secondary" type="text" placeholder="Enter your full name" />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-gray-700 tracking-wide">
                                        Email
